    ...
    return (
        <>
            <div className="parent">
                <img className="image1" src="https://assets.quintevents.com/m/6b6f5727c4107f3/72_DPI_WEB-F1E-Hungary-2022-Champions-Club-07.jpg" alt="..." />
                <div className="gp-card-content">
                    <img className="image2" src={`data:image/png;base64,${base64String}`} alt="..." />
                    <h5 className="gp-card-title">British Grand Prix 2023</h5>
                    <div className="date-container">
                        <img src={CalendarIcon} alt="Calendar" className="calendar-icon date-logo" />
                        <p className="card-date">13 - 15 July 2023</p>
                    </div>
                    <div className="date-container">
                        <img src="https://img.freepik.com/free-vector/illustration-uk-flag_53876-18166.jpg?w=900&t=st=1689852147~exp=1689852747~hmac=6391d4d59781ac2eca15f545c59b93df316789e025a951a0e97b8ba6c80abca0" alt="Calendar" className="calendar-icon" />
                        <p className="card-date">Silverstone Circuit, Great Britain</p>
                    </div>
