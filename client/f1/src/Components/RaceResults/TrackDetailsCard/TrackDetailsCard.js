import './TrackDetailsCard.css';
import Grid from './grid.jpg';
import CalendarIcon from './calendar.png'
function TrackDetailsCard(props) {
        ...
        <>
            <div className='track-details-card'>
                <div className='track-image'>
                    <img src={Grid} className='track-grid'></img>
                    <img className="track" src={`data:image/png;base64,${base64String}`} alt="..." />
                </div>
                <div>
